...
<html>
    ...
    <body>
        ...
        <form action="<%=request.getContextPath()%>/UploadEvaluations" method="POST">
            ...
            <input type="text" id="maxGrades" name="maxGrades" value="100" size=30 maxlength=3>
            ...
            <table cellpadding="3" border="2">
                ...
                <%
                    ...
                    for (User submitter : submittersToEvaluate) {
                        ...
                        out.println("<td><input type='text' name='gradesReceived"+i+"' value='' size=30 maxlength=3></td>");
