...
<html>
	...
	<body>
		...
		<a href="${pageContext.request.contextPath}/update_toi.jsp">Update Topics of Preference</a>
		<a href="${pageContext.request.contextPath}/update_coi.jsp">Update Conflicts of Interest</a>
	</body>
</html>